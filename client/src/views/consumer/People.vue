      ...
      <div class="Profile-mainColumn">
        <el-card class="el_card">
          <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
            <el-tab-pane :label="'动态'+allLength.all" name="PeopleAll"></el-tab-pane>
            <el-tab-pane :label="'影评'+allLength.article" name="PeopleArticle"></el-tab-pane>
            <el-tab-pane :label="'留言'+allLength.paragraph" name="PeopleParagraph"></el-tab-pane>
            <el-tab-pane :label="'回复'+allLength.reply" name="PeopleReply"></el-tab-pane>
          </el-tabs>
...
export default {
  ...
  methods: {
    ...
    getUserInfo() {
      return this.$axios
        .get("/api/users/info", { params: { name: this.userinfo.name } })
        .then(res => {
